...
更多信息，参见 [frontmatter](../PressReference/frontmatter-config)。
...
还可以全局配置中自定义语法高亮主题。有关详细信息，参见 [`markdown` 选项](../PressReference/site-config#markdown)得到更多信息。
...
查看 [`markdown` 选项](../PressReference/site-config#markdown) 获取更多信息。
...
请查看[配置参考：站点配置](../PressReference/site-config#markdown)来获取完整的可配置属性列表。
